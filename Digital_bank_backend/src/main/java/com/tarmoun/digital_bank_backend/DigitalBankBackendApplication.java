package com.tarmoun.digital_bank_backend;
...
import com.tarmoun.digital_bank_backend.security.service.SecurityService;
import com.tarmoun.digital_bank_backend.services.BankAccountService;
import com.tarmoun.digital_bank_backend.services.CustomerService;
...
//            securityService.addNewUser( new AppUser( null, "admin", "admin", new ArrayList<>()));
            securityService.addNewUser( new AppUser( null, "ikram", "1234", new ArrayList<>()));
...
//            securityService.addRoleToUser( "admin", "ADMIN");
            ...
            securityService.addRoleToUser( "ikram", "ADMIN");
...
//    @Bean
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService, CustomerService customerService){
        return args -> {
            Stream.of("TARMOUN AMAL","IKRAM KHADIRI","SOUMIA TARMOUN").forEach(name->{
